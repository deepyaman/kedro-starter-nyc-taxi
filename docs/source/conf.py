...
# nyc_taxi_data_regression documentation build
...
from nyc_taxi_data_regression import __version__ as release

# -- Project information -----------------------------------------------------

project = "nyc_taxi_data_regression"
author = "Kedro"
...
htmlhelp_basename = "nyc_taxi_data_regressiondoc"
...
latex_documents = [
    (
        master_doc,
        "nyc_taxi_data_regression.tex",
        "nyc_taxi_data_regression Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "nyc_taxi_data_regression",
        "Project nyc_taxi_data_regression codebase.",
        "Data-Science",
    )
]
